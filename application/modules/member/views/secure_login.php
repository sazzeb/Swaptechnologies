<div class="container">
    <div class="nz-row">
        ...
        <div class="col vc_col-sm-12 vc_col-lg-5 vc_col-md-5 vc_col-xs-12 col12  element-animate-false valign-top"  data-effect="none" data-align="left">
            <div class="col-inner" >
                <h2 id="h2_5c14_0" class="vc_custom_heading ninzio-latter-spacing">SIGN IN</h2>
                ...
                <p id="p_5c14_0" class="vc_custom_heading">lOGIN to get full access to the site you must login</p>
                ...
                <div role="form" class="wpcf7" id="wpcf7-f6-p3172-o1" lang="en-US" dir="ltr">
                    ...
                    <form id="contact-form" action="<?= $form_validation ?>" method="post">
                        ...
                        <div class="input-group input-group-md">
                            <span class="input-group-addon">Email or username:</span>
                            <input type="text" name="username" placeholder="Enter Your Email or Username or Phone number" value="<?= $username ?>" class="form-control" aria-required="true" aria-invalid="false">
                        </div><br>

                        <div class="input-group input-group-lg">
                            <span class="input-group-addon">Password</span>
                            <input type="password" name="password" placeholder="Enter Your Email or Username or Phone number" class="form-control" aria-required="true" aria-invalid="false">
                        </div><br>

                        <p>Keep Me SignIn <span class="wpcf7-form-control-wrap your-email">
                            <input name="checkbox" value="Long_time_login" id="checkbox" type="checkbox"  size="100" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false"/></span> </p>


                        <button type="submit" name="submit" value="Submit" class="button button-ghost sky full-false small round animate-false anim-type-ghost hover-scene element-animate-fals">Sign In</button><p><a href="<?= base_url() ?>member/reset">Forgot Password</a></p>
                    </form>
                </div>
            </div>
        </div>
