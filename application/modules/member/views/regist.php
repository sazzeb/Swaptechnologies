<?php 
$form_location = base_url().'member/signup';
?>
<div class="container">
    <div class="nz-row">
    <div class="col vc_col-sm-12 vc_col-lg-2 vc_col-md-2 vc_col-xs-12 col12  element-animate-false valign-top"  data-effect="none" data-align="left">
        ...
        <div class="col vc_col-sm-12 vc_col-lg-5 vc_col-md-5 vc_col-xs-12 col12  element-animate-false valign-top"  data-effect="none" data-align="left">
            <div class="col-inner" >
                <h2 id="h2_5c14_0" class="vc_custom_heading ninzio-latter-spacing">SIGN UP</h2>
                ...
                <p id="p_5c14_0" class="vc_custom_heading">Register With us to get our daily news feed</p>
                ...
                <div role="form" class="wpcf7" id="wpcf7-f6-p3172-o1" lang="en-US" dir="ltr">
                    ...
                    <form id="signup-orm" action="<?= $form_location ?>" method="post">
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon vc_col-md-4" style="color: white; background-color: black;">Username:</span>
                            <input type="text" name="username" placeholder="Enter Your Username" value="<?= $username ?>" class="form-control" aria-required="true" aria-invalid="false">
                        </div><br>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon vc_col-md-4" style="color: white; background-color: black;">Email:</span>
                            <input type="text" size="40" name="email" placeholder="Enter Your Email" value="<?= $email ?>" class="form-control" aria-required="true" aria-invalid="false">
                        </div><br>
                        <div class="input-group input-group-md">
                            <span class="input-group-addon vc_col-md-4" style="color: white; background-color: black;">Phone Number:</span>
                            <input type="text" name="telephone" placeholder="Enter Your Phone Number" value="<?= $telephone ?>" class="form-control" aria-required="true" aria-invalid="false">
                        </div><br>
                        <div class="input-group input-group-md">
                            <span class="input-group-addon vc_col-md-4" style="color: white; background-color: black;">Password:</span>
                            <input type="password" name="password" placeholder="Enter Password Here" class="form-control" aria-required="true" aria-invalid="false">
                        </div><br>
                        <div class="input-group input-group-md">
                            <span class="input-group-addon vc_col-md-4" style="color: white; background-color: black;">Confirm Passord:</span>
                            <input type="password" name="confirm_pasword" placeholder="Confirm your Passord" class="form-control" aria-required="true" aria-invalid="false">
                        </div><br>
                        <button type="submit" name="submit" value="Submit" class="button button-ghost sky full-false small round animate-false anim-type-ghost hover-scene element-animate-fals">Sign Up</button>
                    </form>
                </div>
            </div>
        </div>
