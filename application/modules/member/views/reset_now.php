<div class="container">
    ...
    <div class="col vc_col-sm-12 vc_col-lg-2 vc_col-md-2 vc_col-xs-12 col12  element-animate-false valign-top"  data-effect="none" data-align="left">
        ...
        <div class="col vc_col-sm-12 vc_col-lg-5 vc_col-md-5 vc_col-xs-12 col12  element-animate-false valign-top"  data-effect="none" data-align="left">
            <div class="col-inner" >
                <h2 id="h2_5c14_0" class="vc_custom_heading ninzio-latter-spacing">Password Recovery</h2>
                ...
                <p id="p_5c14_0" class="vc_custom_heading">Enter your email so that we can help your recover it</p>
                ...
                <div role="form" class="wpcf7" id="wpcf7-f6-p3172-o1" lang="en-US" dir="ltr">
                    ...
                    <form action="<?= $form_validation ?>" method="post">
                        <div class="input-group input-group-md">
                            <span class="input-group-addon">Recovery Email:</span>
                            <input type="text" name="email" placeholder="Enter your email for recovery" class="form-control" aria-required="true" aria-invalid="false" >
                        </div><br>

                        <button type="submit" name="submit" value="Submit" class="button button-ghost sky full-false small round animate-false anim-type-ghost hover-scene element-animate-fals">Reset Password</button>
                        <button type="submit" name="submit" value="Cancel" class="button button-ghost sky full-false small round animate-false anim-type-ghost hover-scene element-animate-fals">Cancel</button>
                    </form>
                </div>
            </div>
        </div>
