...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
           <div class="panel-heading" style="text-align: center;">Please choose a file from your computer and then press 'Upload'.</div>
            ...
            <div class="row">
                ...
                echo form_open_multipart('swapblog/do_upload/'.$update_id, $attributes);
                ?>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="state-info">Upload: </label>
                            <div class="col-md-6">
