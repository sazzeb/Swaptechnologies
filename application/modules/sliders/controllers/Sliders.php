...
function _attempt_draw_slider()
{
    ...
    $sliders_query = $this->get_where_custom('target_url', $current_url);
    $num_rows = $sliders_query->num_rows();
    ...
    if($num_rows>0)
    {
        ...
        $data['sliders_query'] = $this->slides->get_where_custom('parent_id',$parent_id);
