...
function _process_delete($update_id)
{
    ...
    $picture_path='./robotics/images_galleries/'.$picture;
    ...
    // attempt to delete the item records from robotics 
...
function do_upload($parent_id)
{
    ...
    $config['upload_path']          = './robotics/images_galleries/';
    $config['allowed_types']        = 'gif|jpg|png';
    $config['max_size']             = 800;
    $config['max_width']            = 1624;
    $config['max_height']           = 968;
    $config['file_name']            = $this->swaptechnologies_security->generate_random_string(19);
