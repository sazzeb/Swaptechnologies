           ...
           <div class="panel-heading">Confirm Delete</div>
            ...
            <div class="row">
                ...
                <div  class="flash_align" ">
    				...
    				echo form_open('developers_sub/delete/'.$update_id, $attributes);
    				?>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="state-info"></label>
                             <div class="col-md-4">
                                <button type="submit" value="Yes - Delete" name="submit" class="btn btn-block btn-danger btn-rounded form-control">Yes - Delete</button>
                            </div>
                        </div>
                    </form>
                </div>
