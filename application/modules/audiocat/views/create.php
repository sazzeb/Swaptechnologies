...
<?php
$form_location = base_url()."audiocat/create/".$update_id;
?>
<!--.row-->
<div class="row">
    <div class="col-md-12">
                          ...
                          if ($num_dropdown_options>1) { ?>
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                  ...
                                  echo form_dropdown('audio_parent_cat_id', $options, $audio_parent_cat_id, $additional_dd_code);
                                  ?>
                                </div>
                            </div><?php
                              } else {
                                echo form_hidden('audio_parent_cat_id', 0);
                              }
                              ?>
                            <div class="form-group">
