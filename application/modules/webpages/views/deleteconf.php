...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
           <div class="panel-heading">Delete Delete Webpage</div>
                    ...
                    ?>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="state-info"></label>
                             <div class="col-md-4">
                                <button type="submit" value="DELETED" name="submit" class="btn btn-block btn-danger btn-rounded form-control">Do You Want To Delete The Entire </button>
                            </div>
                            <div class="col-md-2">
