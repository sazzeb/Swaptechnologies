...
function _set_cookie($user_id)
{
    ...
    $data['cookie_code'] = $this->swaptechnologies_security->generate_random_string(255);
    $data['user_id'] = $user_id;
    $data['expiry_date'] = $two_weeks_ahead;
    $this->_insert($data);

    $cookie_name = $this->swaptechnologies_settings->_get_cookie_name();
...
function _attempt_get_user_id()
{
    ...
    if (isset($_COOKIE[$cookie_name])) {
        ...
        //they have the cookie but is it still on the table?
